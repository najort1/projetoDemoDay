...
export const PesquisaVagaTelaInicial = () => {
  ...
  return (
    <>
      ...
      <select name="Tipo" id="selecionado_tipo" className="opcoes-tipo h-[64px] w-20 rounded-[5px]" onChange={handleTipo}>
          <option value="Vagas">Vagas</option>
          <option value="Empresas">Empresas</option>      
      </select>

      <input type="text" placeholder="Pesquise" className="input-pesquisa h-[64px] w-full rounded-[5px] px-[5px]" onChange={handlePesquisa}/>

      <select name="Estado" id="seleciona_estado" className="selecionar-estado h-[64px] w-24 rounded-[5px]" onChange={handleSelectCidade}>
      ...
      <Button
      isIconOnly
      className="botao-pesquisar bg-[#718CB3] flex items-center justify-center h-[64px] w-24"
